...
<template>
  <section class="hero" id="hero">
    <div class="hero-bg">
      <img src="/hero_bg.jpg" alt="" aria-hidden="true" loading="eager">
    </div>
    ...
    <div class="hero-content">
      <div class="hero-text">
        ...
        <h1>
          Defesa jurídica especializada para proteger seu <span class="highlight">patrimônio</span> e seus direitos
        </h1>

        <p class="hero-description">
          Atuação estratégica contra golpes, fraudes bancárias, cobranças abusivas e juros ilegais. Recupere seus valores com quem entende do assunto.
        </p>

        <div class="hero-actions">
          <a href="https://wa.me/5531994394524?text=Ol%C3%A1%2C%20preciso%20de%20orienta%C3%A7%C3%A3o%20jur%C3%ADdica." class="btn btn-whatsapp" target="_blank" rel="noopener noreferrer">
          ...
          <a href="tel:+5531994394524" class="btn btn-outline">
        ...
        <div class="hero-stats">
          ...
          <div class="hero-stat">
            <div class="hero-stat-number">R$2M+</div>
            <div class="hero-stat-label">Valores Recuperados</div>
          </div>
        </div>
      </div>
