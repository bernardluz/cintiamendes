  ...
  <nav class="navbar" :class="{ 'scrolled': isScrolled, 'transparent': !isScrolled }" id="navbar" role="navigation" aria-label="Navegação principal">
    <div class="navbar-inner">
      ...
      <div class="navbar-cta">
        <a href="https://wa.me/5531994394524?text=Ol%C3%A1%2C%20preciso%20de%20orienta%C3%A7%C3%A3o%20jur%C3%ADdica." class="btn btn-whatsapp btn-sm" target="_blank" rel="noopener noreferrer">
